...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 2.4936868820071014; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -6.25; // in; offset of the lateral wheel

    private Encoder leftEncoder, rightEncoder, frontEncoder;
    public static double X_MULTIPLIER = 1.0693137632338787295; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.06986198780357333; // Multiplier in the Y direction
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap) {
        ...
        frontEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "back left"));
